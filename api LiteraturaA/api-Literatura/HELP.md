...
* The original package name 'com.chall.api Literatura' is invalid and this project uses 'com.chall.api.Literatura' instead.
...
```
$ docker run --rm -p 8080:8080 api-Literatura:0.0.1-SNAPSHOT
```
